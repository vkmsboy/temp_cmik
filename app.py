...
async def add_manga_cover(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    logger.info("State: ADD_COVER. Received photo.")
    ...
    async def main():
        ...
        conv_handler = ConversationHandler(
            ...
            states={
                ...
                ADD_COVER: [MessageHandler(filters.PHOTO, add_manga_cover)],
                SELECT_MANGA: [
        ...
        application.add_handler(MessageHandler(filters.ALL, incorrect_input)) # Catch-all for unexpected input
